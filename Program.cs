...
namespace webApi
{
    public class dropbox
    {
        public void UploadAFile(string file_name)
        {
            ...
            rest.AddHeader("Authorization", "Bearer sl.AoGNuM_TPZMRAY8xUPdiDnf6u86E-IUJiri0P_GyRxzB72WF3VWRMKPEiayayoAV4w_bNqTbmMS9GFAGSEZNymvj_oMGtM47-ATBez6nMR-P9mCuCPQBv9vKYga1yMx8OBTRIiSJ3jw");
